...
void setup_ui_rgb(GtkWidget *stack)
{
  ...
  gtk_box_pack_start(GTK_BOX(imageBoxRGB), buttonRotation, FALSE, FALSE, 2);
  ...
  gtk_box_pack_start(GTK_BOX(imageBoxRGB), buttonFilters, FALSE, FALSE, 2);
  ...
  gtk_box_pack_start(GTK_BOX(imageBoxRGB), line, FALSE, FALSE, 2);
  ...
  gtk_box_pack_start(GTK_BOX(imageBoxRGB), randomButton, FALSE, FALSE, 2);
